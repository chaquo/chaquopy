The following Python 3.6 build procedure is based on
https://github.com/inclement/crystax_python_builds. I don't think it's worth fully scripting it
yet.
...
The Python libraries and includes will now be in $CRYSTAX_DIR/sources/python/3.6. These can be
packaged for the Maven repository by package-target.sh, or copied to another machine for Chaqupy
itself to build against.
