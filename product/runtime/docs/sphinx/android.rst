...
slightly slow down your app's startup, so this setting should be used on the deepest possible
package.

For development purposes, it is sometimes useful to extract all packages. This is possible
using a wildcard::
...
If the wildcard is used, all packages are imported before your app's code starts running.
