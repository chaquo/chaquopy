...
class TestStaticProxy(FilterWarningsCase):
    ...
    def test_wrong_load_order(self):
        with self.assertRaisesRegex(TypeError, "static_proxy class "
    ...
    def test_wrong_bases(self):
        with self.assertRaisesRegex(TypeError, "expected extends java.lang.Object, but Java "
                                    "class actually extends java.lang.Exception"):
            class WrongExtends(static_proxy(package="com.chaquo.python.static_proxy")):
                pass

        from java.lang import Runnable
        with self.assertRaisesRegex(TypeError, r"expected implements \['java.lang.Runnable', "
