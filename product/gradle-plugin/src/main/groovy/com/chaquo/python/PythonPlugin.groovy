...
class PythonPlugin implements Plugin<Project> {
    ...
    static final def MIN_ANDROID_PLUGIN_VER = VersionNumber.parse("3.2.0")
    static final def MAX_TESTED_ANDROID_PLUGIN_VER = VersionNumber.parse("3.6.0-rc02")
        ...
        def miscAssetsTask = assetTask(variant, "misc") {
            ...
            doLast {
                ...
                def BOOTSTRAP_NATIVE_STDLIB = [
                    ...
                    "_csv.so",  // importlib.metadata < java.android.importer
