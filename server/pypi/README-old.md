...
This directory contains the build-wheel tool, which produces Android .whl files
compatible with Chaquopy.

If you're using Python 3.13 or newer, we recommend you use cibuildwheel instead, as
described in README.md.


## Setup

This tool can build .whl files for all [Android
...
* Add a `--find-links` option as described in README.md.
